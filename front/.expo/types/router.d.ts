...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/navigation/DrawerNavigator` | `/navigation/StackNavigator` | `/navigation/TabNavigator` | `/navigation/hooks/useHomeStackNavigation` | `/navigation/types/homeStackNavigationTypes` | `/screens/stack/home/DetailsScreen` | `/screens/tab/BagScreen` | `/screens/tab/CheckOutScreen` | `/screens/tab/HomeScreen` | `/screens/tab/SettingsScreen`;
